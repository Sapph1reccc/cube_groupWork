...
rm instance/shunfeng/ORDER_NO.txt
...
rm -f instance/shunfeng/aspect_policy.cfg
...
yes|cp instance/shunfeng/sys_config.cfg.record instance/shunfeng/sys_config.cfg
yes|cp instance/shunfeng/router_policy.cfg.record instance/shunfeng/router_policy.cfg
...
#sh run_cube.sh exec_def/_guke001_client.def login.msg write4.msg &
#sleep 4
...
#sleep 4
#sh run_cube.sh exec_def/_guke002_client.def login.msg write1.msg read.msg &
#sleep 4
#sh run_cube.sh exec_def/_kefu_client.def login.msg write1.msg write2.msg
#sleep 4


#sh run_cube.sh exec_def/_yuantong_client.def login.msg write1.msg &
#sleep 4
sh run_cube.sh exec_def/_shunfeng_client.def login.msg read.msg &
#sleep 4
#sh run_cube.sh exec_def/_dianzhu_client.def login.msg write1.msg
