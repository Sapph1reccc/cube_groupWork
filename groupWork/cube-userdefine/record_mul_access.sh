...
yes|cp instance/yuantong/sys_config.cfg.record instance/dianzhu/sys_config.cfg
yes|cp instance/yuantong/router_policy.cfg.record instance/dianzhu/router_policy.cfg
