...
sleep 1
sh run_cube.sh exec_def/_guke001_client.def &
sleep 1
sh run_cube.sh exec_def/_dianzhu_client.def &
sleep 1
sh run_cube.sh exec_def/_kefu_client.def &
sleep 1
sh run_cube.sh exec_def/_yuantong_client.def 
#login.msg
